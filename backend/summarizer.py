...
def generate_newsletter_html(content_items, podcast_url=None, is_welcome=False):
    ...
    html = f"""
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #ffffff; background-color: #000000; padding: 20px;">
        <h1 style="color: #F97316; text-align: center; font-size: 28px; margin-bottom: 5px;">Neural News Daily Intelligence</h1>
        <p style="text-align: center; color: #aaaaaa; margin-top: 0; font-size: 14px;">The noise of AI, turned into signal.</p>
        <hr style="border: 1px solid #333333; margin: 20px 0;" />
    """
    
    if is_welcome:
        html += """
        <div style="background-color: #111111; padding: 15px; border-radius: 8px; text-align: center; margin-bottom: 20px; border: 1px solid #333333;">
            <h3 style="margin-top: 0; color: #ffffff;">👋 Welcome to the club.</h3>
    ...
    html += """
        <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #333333; text-align: center;">
            <p style="font-size: 12px; color: #666666; margin: 0;">Neural Newz Automation · Built with AI</p>
            <p style="font-size: 11px; color: #555555; margin-top: 8px;">You are receiving this because you subscribed to Neural Newz.</p>
        </div>
    </div>
    """
